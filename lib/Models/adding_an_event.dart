class AddingAnEvent {
  ...
  static const String tableName = "Event_Form";

  static const String columnLocalId = "local_id";
  static const String columnNameOfEvent = "name_of_event";
  ...
  factory AddingAnEvent.fromJson(Map<String, dynamic> json) {
    return AddingAnEvent(
      local_id: json['local_id'],
      name_of_event: json['name_of_event'],
      date: json['date'],
  ...
  factory AddingAnEvent.fromMap(Map<String, dynamic> json) => AddingAnEvent(
